...
_EXECUTOR_ALL = frozenset({"executor.apply", "executor.rollback", "executor.diff", "executor.run"})
...
AGENT_TOOLS = (
    _CONTEXT_ALL | _RNA_ALL | _RESEARCH_ALL | _EXECUTOR_ALL | _GIT_ALL | _VERIFY_ALL | _PLANNING_ALL
)
